...
public class ScreenNameSelection extends AppCompatActivity {
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (displayName.length() >=3){
                    ...
                    saveToFireStore(ScreenNameSelection.this, enteredDisplayName);
                }
                else {
                    Toast.makeText(ScreenNameSelection.this, "Display name should be at least" +
        ...
        db.collection(userCollection).document(userID)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //Call main activity
                        Intent mainActivity = new Intent(ScreenNameSelection.this, MainActivity.class);
